using System.Linq;
using CppSharp.AST;
using LibMpv.AutoGen.CppSharpUnsafeGenerator.Definitions;
using MacroDefinition = LibMpv.AutoGen.CppSharpUnsafeGenerator.Definitions.MacroDefinition;

namespace LibMpv.AutoGen.CppSharpUnsafeGenerator.Processing;
