...
public sealed class FunctionsGenerator : GeneratorBase<ExportFunctionDefinition>
{
    ...
    public override IEnumerable<string> Usings()
    {
        ...
        if (!Context.IsLegacyGenerationOn && (IsStaticallyLinkedGenerationOn || IsDynamicallyLinkedGenerationOn || IsDynamicallyLoadedGenerationOn))
            yield return "CSharpFromC.Generator.Abstractions";
    }
    ...
    private void GenerateDynamicallyLoaded(ExportFunctionDefinition function)
    {
        ...
        {
            var functionDelegateName = GetFunctionDelegateName(function);
            var getDelegate = $"FunctionResolver.GetFunctionDelegate<Vectors.{functionDelegateName}>(\"{function.LibraryName}\", \"{function.ExportName}\", ThrowErrorIfFunctionNotFound)";
    ...
    private static string GetFunctionDelegateName(ExportFunctionDefinition function) => $"{function.Name}Delegate";
}
